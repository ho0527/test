        ...
        <?php
            ...
            if(isset($_SESSION["todoval"])){
                ...
                <form>
                    ...
                    開始時間:
                    <select name="start-hr" value="<?php echo(substr($row[3],0,2)); ?>">
                        <option>hr</option>
                        <?php
                            for($i=0;$i<24;$i=$i+1){
                    ...
                    <select name="start-min" value="<?php echo(substr($row[3],3,5)); ?>">
                        <?php
                    ...
                    結束時間:
                    <select name="end-hr" value="<?php echo(substr($row[4],0,2)); ?>">
                        <option>hr</option>
                        <?php
                            for($i=0;$i<24;$i=$i+1){
                    ...
                    處理情形:
                    <select name="deal" id="deal" value="<?= $row[5]; ?>">
                        <?php
                        if($row[5]=="普通"){
                            ?>
                    ...
                    類別:
                    <select name="priority" id="priority" value="<?= $row[6]; ?>">
                        <?php
                        if($row[6]=="未處理"){
                            ?>
                ...
                ?>
                <form>
                    工作標題:<input type="text" name="title" value="work<?php ?>" id="title"><br><br>
