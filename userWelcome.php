                            ...
                            <form>
                                ...
                                <?php
                                    ...
                                    if(isset($_SESSION["priority"])||isset($_SESSION["deal"])){
                                        ...
                                        if($deal=="未處理"){
                                            if($priority=="普通"){
                                                $todo=mysqli_query($db,"SELECT*FROM `todo` WHERE `deal`='未處理' AND `priority`='普通' AND `date`='$date'");
                                                uper($todo);
                                            }elseif($priority=="速件"){
                                                $todo=mysqli_query($db,"SELECT*FROM `todo` WHERE `deal`='未處理' AND `priority`='速件' AND `date`='$date'");
                                                uper($todo);
                                            }elseif($priority=="最速件"){
                                                $todo=mysqli_query($db,"SELECT*FROM `todo` WHERE `deal`='未處理' AND `priority`='最速件' AND `date`='$date'");
                                                uper($todo);
                                            }else{
                                                $todo=mysqli_query($db,"SELECT*FROM `todo` WHERE `deal`='未處理' AND `date`='$date'");
                                                uper($todo);
                                            }
                                        }elseif($deal=="處理中"){
                                            if($priority=="普通"){
                                                $todo=mysqli_query($db,"SELECT*FROM `todo` WHERE `deal`='處理中' AND `priority`='普通' AND `date`='$date'");
                                                uper($todo);
                                            }elseif($priority=="速件"){
                                                $todo=mysqli_query($db,"SELECT*FROM `todo` WHERE `deal`='處理中' AND `priority`='速件' AND `date`='$date'");
                                                uper($todo);
                                            }elseif($priority=="最速件"){
                                                $todo=mysqli_query($db,"SELECT*FROM `todo` WHERE `deal`='處理中' AND `priority`='最速件' AND `date`='$date'");
                                                uper($todo);
                                            }else{
                                                $todo=mysqli_query($db,"SELECT*FROM `todo` WHERE `deal`='處理中' AND `date`='$date'");
                                                uper($todo);
                                            }
                                        }elseif($deal=="已完成"){
                                            if($priority=="普通"){
                                                $todo=mysqli_query($db,"SELECT*FROM `todo` WHERE `deal`='已完成' AND `priority`='普通' AND `date`='$date'");
                                                uper($todo);
                                            }elseif($priority=="速件"){
                                                $todo=mysqli_query($db,"SELECT*FROM `todo` WHERE `deal`='已完成' AND `priority`='速件' AND `date`='$date'");
                                                uper($todo);
                                            }elseif($priority=="最速件"){
                                                $todo=mysqli_query($db,"SELECT*FROM `todo` WHERE `deal`='已完成' AND `priority`='最速件' AND `date`='$date'");
                                                uper($todo);
                                            }else{
                                                $todo=mysqli_query($db,"SELECT*FROM `todo` WHERE `deal`='已完成' AND `date`='$date'");
                                                uper($todo);
                                            }
                                        }else{
                                            if($priority=="普通"){
                                                $todo=mysqli_query($db,"SELECT*FROM `todo` WHERE `priority`='普通' AND `date`='$date'");
                                                uper($todo);
                                            }elseif($priority=="速件"){
                                                $todo=mysqli_query($db,"SELECT*FROM `todo` WHERE `priority`='速件' AND `date`='$date'");
                                                uper($todo);
                                            }elseif($priority=="最速件"){
                                                $todo=mysqli_query($db,"SELECT*FROM `todo` WHERE `priority`='最速件' AND `date`='$date'");
                                                uper($todo);
                                            }else{
                                                unset($_SESSION["deal"]);
